...
class ImportController extends Controller
{
    ...
    public function get()
    {
      ...
      $finalArray[] = "SKU;"."Product Name;"."Published;"."Featured;"."Short Description;"."Allow Customer Reviews;"."Regular Price;"."Sale Price;"."Category;\n";

      echo "<a style='color:red;'><b>>[Querying database.. please wait..]</b></a><br/>";

      $result = DB::select('SELECT Artigo, Descricao, Familia, SubFamilia, CDU_site, CDU_destaque, CDU_pvp1site, CDU_pvp2site, CDU_subcategoria FROM dbo.Artigo WHERE CDU_site = 1');
      foreach ($result as $line)
      {
          ...
          if(empty($subSubFamily)){
            $csvString = $referal.";".$productName.";".$published.";".$isFeatured.";".$shortDescription.";".$allowCustomerReviews.";".$regularPrice.";".$salePrice.";".$familyNameLevel1." > ".$familyNameLevel2.";\n";
          }else{
            $csvString = $referal.";".$productName.";".$published.";".$isFeatured.";".$shortDescription.";".$allowCustomerReviews.";".$regularPrice.";".$salePrice.";".$familyNameLevel1." > ".$familyNameLevel2." > ".$subSubFamily.";\n";
          }
